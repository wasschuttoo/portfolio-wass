...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://wassilchuttoo.dev';

  return [
    { url: baseUrl, lastModified: new Date(), changeFrequency: 'monthly', priority: 1 },
    { url: `${baseUrl}/about`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${baseUrl}/experience`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${baseUrl}/certifications`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.7 },
